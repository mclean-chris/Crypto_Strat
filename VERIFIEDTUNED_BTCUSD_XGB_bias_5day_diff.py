...
output_stats_file = f"{output_folder}/BTCUSD_XGB_diff_close_moving_data_len_l05s05_sl05.csv"
...
stop_loss_thresh = 0.0625   #0.025 for 24hr, 0.05 for 5 day, 0.10 for 20 da
