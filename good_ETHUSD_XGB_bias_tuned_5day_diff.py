...
output_stats_file = f"{output_folder}/ethusd_XGB_diff_close_moving_data_len_l05s15.csv"
...
#XGB scaling
    ...
    #             try:
    #                 model = ARIMA(y_train, order=(p,d,q)).fit(method_kwargs={'maxiter':200})
    ...
    #     ARIMA_forecast = ARIMA_fit.get_forecast(steps = pred_len).predicted_mean -ARIMA_fit.resid.mean()
    ...
    #     # AR_pred_close = ARIMA_forecast[-1][0]
    #     AR_pred_pct_del = (AR_pred_close - act_enter)/act_enter 
    #     # -0.04 #some bias in the model -0.04
...
# forecast loop for XGB
    ...
    # forecast_y_train = forecast_y_train - best_model./get
