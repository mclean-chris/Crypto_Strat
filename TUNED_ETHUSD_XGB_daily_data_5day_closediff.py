...
output_stats_file = f"{output_folder}/ETHUSD_XGB_diff_close_moving_data_len_l05s05_sl05.csv"
start_simulation_date = '2019-01-01' 
filename = 'ETHUSD.csv'
long_thresh = 0.01    #0.0375 for 1 day
...
stop_loss_thresh = 0.025   #0.025 for 24hr, 0.05 for 5 day, 0.10 for 20 da
